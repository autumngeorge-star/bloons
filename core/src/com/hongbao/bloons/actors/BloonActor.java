...
public class BloonActor extends RenderableActor {
	...
	public BloonActor(Bloon bloon, float x, float y, BloonActor parent) {
		...
		TextureAtlas atlas = app.getAssetManager().get("bloons.atlas", TextureAtlas.class);
		this.textureRegion = atlas.findRegion(bloon.getAtlasRegionName());
		if (this.textureRegion == null) {
			throw new IllegalArgumentException("Region " + bloon.getAtlasRegionName() + " not found in bloons.atlas");
		}
