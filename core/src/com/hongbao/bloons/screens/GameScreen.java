...
public class GameScreen implements Screen {
	...
	public GameScreen(BloonsTouhouDefense game, MapType mapType) {
		this.game = game;
		this.mapType = mapType != null ? mapType : MapType.BASIC;
	}
	...
	public void show() {
		...
		if (game.getMusicPlayer() != null) {
			game.getMusicPlayer().playStageMusic();
		}
	}
	...
	private void createMenu() {
		...
		// Exit to Map Selection Button
		TextButton exitButton = new TextButton("MAP SELECTION", skin);
		exitButton.setPosition(1505, 855);
	...
	public void createMap() {
		...
		map = MapFactory.createMap(mapType, stage);
