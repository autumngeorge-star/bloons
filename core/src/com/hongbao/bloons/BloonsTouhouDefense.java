...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	public void create() {
		...
		autoContinue = false;
		stage = new Stage();
		stageLayers = new StageLayers(stage);
	...
	private void createInstructions() {
		...
		stageLayers.getMenuItemLayer().addActor(instructions.get(0));
	}
	...
	private void createMenu() {
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(background, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(title, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(moneyLabel, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(healthLabel, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseReimu, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(reimuCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseYukari, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(yukariCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseMarisa, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(marisaCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseAlice, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(aliceCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseSakuya, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(sakuyaCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseRemilia, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(remiliaCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseYoumu, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(youmuCost, ZIndex.MENU_ITEM_Z_INDEX));
		...
		stageLayers.getMenuLayer().addActor(new RenderableImageButton(purchaseYuyuko, ZIndex.MENU_Z_INDEX));
		...
		stageLayers.getMenuItemLayer().addActor(new RenderableLabel(yuyukoCost, ZIndex.MENU_ITEM_Z_INDEX));
	}
	...
	public void createMap() {
		...
		map = MapFactory.createHeaterMap(stage, stageLayers);
		...
		stageLayers.getMapLayer().addActor(backgroundMap);
	}
