...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	public TextureAtlas.AtlasRegion getAtlasRegion(String path) {
		if (path == null) return null;
		String regionKey = path;
		if (regionKey.startsWith("img/")) {
			regionKey = regionKey.substring(4);
		}
		if (regionKey.endsWith(".png")) {
			regionKey = regionKey.substring(0, regionKey.length() - 4);
		}
		TextureAtlas atlas = assetManager.get("game.atlas", TextureAtlas.class);
		TextureAtlas.AtlasRegion region = atlas.findRegion(regionKey);
		if (region == null) {
			Gdx.app.error("BloonsTouhouDefense", "Could not find region: " + regionKey + " (from path: " + path + ")");
		}
		return region;
	}

	private void createInstructions() {
		ImageButton instructions1 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/title.png")));
		...
		ImageButton instructions2 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/objective.png")));
		...
		ImageButton instructions3 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/bloons.png")));
		...
		ImageButton instructions4 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/blimps.png")));
		...
		ImageButton instructions5 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/girls.png")));
		...
		ImageButton instructions6 = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/instructions/shortcuts.png")));
	...
	private void createMenu() {
		...
		ImageButton background = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/header.png")));
		...
		ImageButton purchaseReimu = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/reimu_box.png")));
		...
		ImageButton purchaseYukari = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/yukari_box.png")));
		...
		ImageButton purchaseMarisa = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/marisa_box.png")));
		...
		ImageButton purchaseAlice = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/alice_box.png")));
		...
		ImageButton purchaseSakuya = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/sakuya_box.png")));
		...
		ImageButton purchaseRemilia = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/remilia_box.png")));
		...
		ImageButton purchaseYoumu = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/youmu_box.png")));
		...
		ImageButton purchaseYuyuko = new ImageButton(new TextureRegionDrawable(getAtlasRegion("img/ui/yuyuko_box.png")));
	...
	public void createMap() {
		...
		Drawable drawable = new TextureRegionDrawable(getAtlasRegion(map.getBackgroundImageFilePath()));
