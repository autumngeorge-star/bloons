...
import com.hongbao.bloons.helpers.TextureCache;
...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	private void createInstructions() {
		ImageButton instructions1 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/title.png")));
		...
		ImageButton instructions2 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/objective.png")));
		...
		ImageButton instructions3 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/bloons.png")));
		...
		ImageButton instructions4 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/blimps.png")));
		...
		ImageButton instructions5 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/girls.png")));
		...
		ImageButton instructions6 = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/instructions/shortcuts.png")));
	...
	private void createMenu() {
		...
		ImageButton background = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/header.png")));
		...
		ImageButton purchaseReimu = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/reimu_box.png")));
		...
		ImageButton purchaseYukari = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/yukari_box.png")));
		...
		ImageButton purchaseMarisa = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/marisa_box.png")));
		...
		ImageButton purchaseAlice = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/alice_box.png")));
		...
		ImageButton purchaseSakuya = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/sakuya_box.png")));
		...
		ImageButton purchaseRemilia = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/remilia_box.png")));
		...
		ImageButton purchaseYoumu = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/youmu_box.png")));
		...
		ImageButton purchaseYuyuko = new ImageButton(new TextureRegionDrawable(TextureCache.getTextureRegion("img/ui/yuyuko_box.png")));
	...
	public void createMap() {
		...
		Drawable drawable = new TextureRegionDrawable(TextureCache.getTextureRegion(map.getBackgroundImageFilePath()));
