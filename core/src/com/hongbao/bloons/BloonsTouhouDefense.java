...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	private void createInstructions() {
		...
		for (String path : paths) {
			...
			ImageButton instructionBtn = new ImageButton(UIManager.getInstance().getDrawable(path));
			instructionBtn.setPosition(376, 300);
			instructionBtn.addListener(new ClickListener() {
				@Override
				public void clicked(InputEvent event, float x, float y) {
					updateInstructions();
				}
			});
			instructions.add(new RenderableImageButton(instructionBtn, ZIndex.MENU_ITEM_Z_INDEX));
		}
	...
	private void updateInstructions() {
		if (!instructions.isEmpty()) {
			...
			if (!instructionPaths.isEmpty()) {
				String path = instructionPaths.remove(0);
				UIManager.getInstance().unloadTexture(path);
			}
	...
	private void createMenu() {
		...
		ImageButton background = new ImageButton(UIManager.getInstance().getDrawable("img/ui/header.png"));
		...
		ImageButton purchaseReimu = new ImageButton(UIManager.getInstance().getDrawable("img/ui/reimu_box.png"));
		...
		ImageButton purchaseYukari = new ImageButton(UIManager.getInstance().getDrawable("img/ui/yukari_box.png"));
		...
		ImageButton purchaseMarisa = new ImageButton(UIManager.getInstance().getDrawable("img/ui/marisa_box.png"));
		...
		ImageButton purchaseAlice = new ImageButton(UIManager.getInstance().getDrawable("img/ui/alice_box.png"));
		...
		ImageButton purchaseSakuya = new ImageButton(UIManager.getInstance().getDrawable("img/ui/sakuya_box.png"));
		...
		ImageButton purchaseRemilia = new ImageButton(UIManager.getInstance().getDrawable("img/ui/remilia_box.png"));
		...
		ImageButton purchaseYoumu = new ImageButton(UIManager.getInstance().getDrawable("img/ui/youmu_box.png"));
		...
		ImageButton purchaseYuyuko = new ImageButton(UIManager.getInstance().getDrawable("img/ui/yuyuko_box.png"));
	...
	public void createMap() {
		...
		Drawable drawable = UIManager.getInstance().getDrawable(map.getBackgroundImageFilePath());
