...
import com.hongbao.bloons.cache.TextureCache;
...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	private void createInstructions() {
		ImageButton instructions1 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/title.png"))));
		...
		ImageButton instructions2 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/objective.png"))));
		...
		ImageButton instructions3 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/bloons.png"))));
		...
		ImageButton instructions4 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/blimps.png"))));
		...
		ImageButton instructions5 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/girls.png"))));
		...
		ImageButton instructions6 = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/instructions/shortcuts.png"))));
	...
	private void createMenu() {
		...
		ImageButton background = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/header.png"))));
		...
		ImageButton purchaseReimu = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/reimu_box.png"))));
		...
		ImageButton purchaseYukari = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/yukari_box.png"))));
		...
		ImageButton purchaseMarisa = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/marisa_box.png"))));
		...
		ImageButton purchaseAlice = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/alice_box.png"))));
		...
		ImageButton purchaseSakuya = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/sakuya_box.png"))));
		...
		ImageButton purchaseRemilia = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/remilia_box.png"))));
		...
		ImageButton purchaseYoumu = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/youmu_box.png"))));
		...
		ImageButton purchaseYuyuko = new ImageButton(new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture("img/ui/yuyuko_box.png"))));
	...
	public void createMap() {
		...
		Drawable drawable = new TextureRegionDrawable(new TextureRegion(TextureCache.getTexture(map.getBackgroundImageFilePath())));
