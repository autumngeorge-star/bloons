...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	private void preloadAssets() {
		...
		assetManager.load("img/characters/characters.png", Texture.class);
		...
		assetManager.load("img/projectiles/black_spell_card.png", Texture.class);
		assetManager.load("img/projectiles/projectiles.png", Texture.class);
		...
		String[] bloonTypes = {
			...
			"lead", "zebra", "rainbow", "ceramic", "moab", "bfb", "zomg"
		};
		for (String type : bloonTypes) {
			assetManager.load("img/bloons/" + type + "_bloon.png", Texture.class);
			if (!type.equals("moab") && !type.equals("bfb") && !type.equals("zomg")) {
				assetManager.load("img/bloons/" + type + "_regrowth_bloon.png", Texture.class);
				assetManager.load("img/bloons/" + type + "_camo_bloon.png", Texture.class);
				assetManager.load("img/bloons/" + type + "_camo_regrowth_bloon.png", Texture.class);
			}
		}
