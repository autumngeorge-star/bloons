...
public class BloonsTouhouDefense implements ApplicationListener {
	...
	private void createMenu() {
		...
		scoreLabel.setPosition(1515, 740);
		...
		Label highScoreLabel = new Label("High: " + player.getHighScore(), skin);
		highScoreLabel.setPosition(1650, 740);
		highScoreLabel.setFontScale(1.1f, 1.1f);
		final RunnableAction highScoreLabelAction = new RunnableAction();
		highScoreLabelAction.setRunnable(() -> ((Label)highScoreLabelAction.getActor()).setText("High: " + player.getHighScore()));
