...
public class Map {
	...
	public Map(String backgroundImage, Stage stage) {
		...
		ImageButton infoBackground = new ImageButton(new TextureRegionDrawable(new TextureRegion(((BloonsTouhouDefense) Gdx.app.getApplicationListener()).getTexture("img/ui/girl_details_template.png"))));
