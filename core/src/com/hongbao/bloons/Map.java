...
public class Map {
	...
	public Map(String backgroundImage, Stage stage) {
		...
		uiBackgroundTexture = new Texture(Gdx.files.internal("img/ui/girl_details_template.png"));
		ImageButton infoBackground = new ImageButton(new TextureRegionDrawable(new TextureRegion(uiBackgroundTexture)));
