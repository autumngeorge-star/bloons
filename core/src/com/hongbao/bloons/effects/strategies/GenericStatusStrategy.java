...
public class GenericStatusStrategy implements StatusEffectStrategy {
    ...
    public GenericStatusStrategy(float duration, float intensity, float tickInterval, int tickDamage, StatusEffectType type) {
        this.initialDuration = duration;
        this.remainingDuration = duration;
        this.intensity = intensity;
        this.tickInterval = tickInterval;
        this.tickDamage = tickDamage;
        this.type = type != null ? type : StatusEffectType.GENERIC;
