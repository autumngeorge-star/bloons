...
import com.hongbao.bloons.UIManager;
...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage) {
		return createBasicMap(stage, UIManager.getInstance());
	}

	public static Map createBasicMap(Stage stage, UIManager uiManager) {
		Map map = new Map("basic_map.png", stage, uiManager);
	...
	public static Map createMapWithTurn(Stage stage) {
		return createMapWithTurn(stage, UIManager.getInstance());
	}

	public static Map createMapWithTurn(Stage stage, UIManager uiManager) {
		Map map = new Map("map_with_turn.png", stage, uiManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage) {
		return createHeaterMap(stage, UIManager.getInstance());
	}

	public static Map createHeaterMap(Stage stage, UIManager uiManager) {
		Map map = new Map("heater.png", stage, uiManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
