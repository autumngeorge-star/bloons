...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage, DisposableRegistry disposableRegistry) {
		Map map = new Map("basic_map.png", stage, disposableRegistry);
	...
	public static Map createMapWithTurn(Stage stage, DisposableRegistry disposableRegistry) {
		Map map = new Map("map_with_turn.png", stage, disposableRegistry);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage, DisposableRegistry disposableRegistry) {
		Map map = new Map("heater.png", stage, disposableRegistry);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
