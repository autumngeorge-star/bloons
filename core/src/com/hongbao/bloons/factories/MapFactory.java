...
import com.hongbao.bloons.AudioManager;
...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage, AudioManager audioManager) {
		Map map = new Map("basic_map.png", stage, audioManager);
	...
	public static Map createMapWithTurn(Stage stage, AudioManager audioManager) {
		Map map = new Map("map_with_turn.png", stage, audioManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage, AudioManager audioManager) {
		Map map = new Map("heater.png", stage, audioManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
