...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage) {
		return createBasicMap(stage, new StageLayers(stage));
	}

	public static Map createBasicMap(Stage stage, StageLayers stageLayers) {
		Map map = new Map("basic_map.png", stage, stageLayers);
	...
	public static Map createMapWithTurn(Stage stage) {
		return createMapWithTurn(stage, new StageLayers(stage));
	}

	public static Map createMapWithTurn(Stage stage, StageLayers stageLayers) {
		Map map = new Map("map_with_turn.png", stage, stageLayers);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage) {
		return createHeaterMap(stage, new StageLayers(stage));
	}

	public static Map createHeaterMap(Stage stage, StageLayers stageLayers) {
		Map map = new Map("heater.png", stage, stageLayers);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
