...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage) {
		return createBasicMap(stage, new SoundManager());
	}

	public static Map createBasicMap(Stage stage, SoundManager soundManager) {
		Map map = new Map("basic_map.png", stage, soundManager);
	...
	public static Map createMapWithTurn(Stage stage) {
		return createMapWithTurn(stage, new SoundManager());
	}

	public static Map createMapWithTurn(Stage stage, SoundManager soundManager) {
		Map map = new Map("map_with_turn.png", stage, soundManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage) {
		return createHeaterMap(stage, new SoundManager());
	}

	public static Map createHeaterMap(Stage stage, SoundManager soundManager) {
		Map map = new Map("heater.png", stage, soundManager);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
