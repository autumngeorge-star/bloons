...
import com.hongbao.bloons.AudioController;
...
public class MapFactory {
	...
	public static Map createBasicMap(Stage stage) {
		return createBasicMap(stage, null);
	}

	public static Map createBasicMap(Stage stage, AudioController audioController) {
		Map map = new Map("basic_map.png", stage, audioController);
	...
	public static Map createMapWithTurn(Stage stage) {
		return createMapWithTurn(stage, null);
	}

	public static Map createMapWithTurn(Stage stage, AudioController audioController) {
		Map map = new Map("map_with_turn.png", stage, audioController);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
	...
	public static Map createHeaterMap(Stage stage) {
		return createHeaterMap(stage, null);
	}

	public static Map createHeaterMap(Stage stage, AudioController audioController) {
		Map map = new Map("heater.png", stage, audioController);
		Pair<Float, Float>[][] directions = initializeEmptyDirections();
